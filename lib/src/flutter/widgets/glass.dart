...
/// A widget that represents a glass-like effect with frosted glass and shadow.
///
/// Example:
/// ```dart
/// RushGlass(
...
/// )
/// ```
class RushGlass extends StatelessWidget {
  /// Creates a RushGlass widget.
  const RushGlass({
    super.key,
    this.opacity = 0.05,
    this.child,
  ...
  ///[RushGlass] Height in [double]\n
  ///no default height
  final double? height;

  ///[RushGlass] Width in [double]\n
  ///no default width
  final double? width;
...
/// Extension method to directly access  [RushGlass] with any widget
/// without wrapping or with dot operator.
extension RushGlassWidgetExtension on Widget {
  ///
  /// Extension method to directly access  [RushGlass] with any widget
  /// without wrapping or with dot operator.
  ///
